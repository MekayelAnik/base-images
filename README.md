...
| `moby/buildkit:master` | `ghcr.io/mekayelanik/base-images/moby/buildkit:master` | linux/amd64,linux/arm/v7 linux/arm64,linux/ppc64le linux/riscv64,linux/s390x | codegraphcontext-mcp-docker, context7-mcp-docker, db-mcp-server-docker, duckduckgo-mcp-docker, fetch-mcp-docker, filesystem-mcp-docker, gitnexus-docker, ispyagentdvr-base-image, ispyagentdvr-docker, knowledge-graph-mcp-docker, nfs-server-alpine, pypi-query-mcp-server-docker, redis-mcp-server-docker, samba-server-alpine, semgrep-mcp-docker, serena-mcp-docker, snyk-mcp-docker, valkey-mcp-docker, vllm-cpu | Mirrored | 2026-08-09 10:33 UTC |
